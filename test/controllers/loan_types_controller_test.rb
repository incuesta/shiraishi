...
class LoanTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loan_type" do
    assert_difference('LoanType.count') do
      post loan_types_url, params: { loan_type: { code: @loan_type.code, interest_mode: @loan_type.interest_mode, name: @loan_type.name, rate: @loan_type.rate, repayment_method: @loan_type.repayment_method } }
    end
  ...
  test "should update loan_type" do
    patch loan_type_url(@loan_type), params: { loan_type: { code: @loan_type.code, interest_mode: @loan_type.interest_mode, name: @loan_type.name, rate: @loan_type.rate, repayment_method: @loan_type.repayment_method } }
